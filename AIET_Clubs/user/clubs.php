        ...
        <div class="flex flex-col justify-center items-center bg-slate-100 max-w-7xl">
            ...
            <div class="flex flex-col items-center justify-evenly my-12 lg:px-10 lg:flex-row space-y-8 lg:space-y-0">
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase" ><a href="../user ourclubs/Rostrum.php">1. Rostrum</a> </h1>
                ...
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase   "><a href="../user ourclubs/Srishti.php"> 2. Srishti – The Nature Club</a></h1>
                ...
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase   "><a href="../user ourclubs/edwins.php"> 3. Edwin Linux Lab</a></h1>
            ...
            <div class="flex flex-col items-center justify-evenly my-12 lg:px-10 lg:flex-row space-y-8 lg:space-y-0 ">
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase  animate__animated animate__flipInY "><a href="../user ourclubs/algori.php"> 4. Algories Club</a></h1>
                ...
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase  animate__animated animate__flipInY "><a href="../user ourclubs/Apple.php">5. Apple iOS LAB</a> </h1>
                ...
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase   "><a href="../user ourclubs/nss.php">6. NSS</a></h1>
            ...
            <div class="flex flex-col items-center justify-evenly my-12 lg:px-10 lg:flex-row space-y-8 lg:space-y-0 ">
                <div
                    ...
                    <h1 class="text-xl tracking-tight font-semibold text-green-600 uppercase   "><a href="../user ourclubs/ncc.php">7. NCC</a></h1>
