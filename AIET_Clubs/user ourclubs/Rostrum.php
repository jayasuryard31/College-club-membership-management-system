                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">ROSTRUM CLUB</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img src="../images/Rostrum.png" alt=""
                                                                            class="rounded-full" />
                                                                    </div>
                                                                    <div class="flex flex-col w-full md:w-2/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">ROSTRUM – The Speakers’ Club at Alva’s is a platform for students to thought-process in various socio-cultural, political issues for over a decade. Rostrum brings in about 15 speakers a year and conducts activities like debate, panel discussion, campus parliament and many more.</div>
                                                                        <!-- <div class="font-bold text-2xl text-blue-500 ">John Doe</div> -->
                                                                        <div class="text-stone-500 text-sm   "><a href="https://www.aiet.org.in/clubs-activities/rostrum/">more...</a></div>
                                                                    </div>
                                                                </div>
                                                            </div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'Rostrum'";
...
?>
        ...
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Rostrum'";
...
$sql   ="Select * from `members` where `club_name` = 'Rostrum'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
