                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">NCC</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">Alva’s Institute Of Engineering & Technology (AIET) is a premier Engineering Institute of Alva’s Education Foundation established in the year 2008. AIET is strategically located adjacent to Moodbidri -Mangalore National Highway, which is 24 Kms from Mangalore International Airport.

It has a lush green campus spread over 30 acres; a part of ALVA’S-SHOBHAVANA, 144 acres spread on a famous herbal garden with more than two thousand variety of herbal plants.</div>
                                                                        <!-- <div class="font-bold text-2xl text-blue-500 ">John Doe</div> -->
                                                                        <div class="text-stone-500 text-sm   "><a href="https://www.aiet.org.in/clubs-activities/ncc/">more...</a></div>
                                                                    </div>
                                                                </div>
                                                            </div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'NCC'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'NCC'";
...
$sql   ="Select * from `members` where `club_name` = 'NCC'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
