                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">Algoris club</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img src="../images/algori.png" alt=".../"
                                                                            class="rounded-full" />
                                                                    </div>
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">Students were introduced to Algorithm concepts. All the students learnt about Algorithm to add two numbers, Algorithm to find the largest among three numbers, Algorithm to find all the roots of the quadratic equation, Algorithm to find the factorial, Algorithm to check prime number, Algorithm of Fibonacci series. Further, students were made hands on session, by getting familiar with basic algorithms in computer science.</div>
                                                                        <!-- <div class="font-bold text-2xl text-blue-500 ">John Doe</div> -->
                                                                        <div class="text-stone-500 text-sm   "><a href="https://www.aiet.org.in/clubs-activities/algoris-club/">more...</a></div>
                                                                    </div>
                                                                </div>
                                                            </div>
...
$sql ="Select * from `clubinfo`where `club_name` = 'Algoris Club'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Algoris Club'";
...
$sql   ="Select * from `members` where `club_name` = 'Algoris Club'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
