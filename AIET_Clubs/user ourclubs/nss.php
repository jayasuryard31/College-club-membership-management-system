                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">NSS</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img src="../images/nss.png" alt=".../"
                                                                            class="rounded-full" />
                                                                    </div>
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">National Service Scheme (NSS) is a Central Sector Scheme of Government of India, Ministry of Youth Affairs & Sports. It was launched on 24th September, 1969, with the primary objective of developing the personality and character of the student youth through voluntary community service. It also provides opportunity to take part in various government led community service activities & programmes. The ideological orientation of the NSS is inspired by the ideals of Mahatma Gandhi. The motto of NSS is “NOT ME BUT YOU”.</div>
                                                                        <!-- <div class="font-bold text-2xl text-blue-500 ">John Doe</div> -->
                                                                        <div class="text-stone-500 text-sm   "><a href="https://www.aiet.org.in/clubs-activities/nss/">more...</a></div>
                                                                    </div>
                                                                </div>
                                                            </div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'NSS'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'NSS'";
...
$sql   ="Select * from `members` where `club_name` = 'NSS'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
