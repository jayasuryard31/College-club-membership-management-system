            ...
            <div class="self-center top-0 w-full max-w-7xl ">
                <div class="flex justify-between items-center text-gray-700">
                    ...
                    <ul class="hidden md:flex items-center text-[18px] font-semibold pr-10">
                        ...
                        <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1"><a href="dashboard.php">
                                dashboard</a></li>
            ...
            <div class="self-center top-0 w-full max-w-7xl ">
                <div class="flex justify-between items-center text-gray-700">
                    ...
                    <ul class="hidden md:flex items-center text-[18px] font-semibold pr-10">
                        ...
                        <button type="button" class="text-white hover:text-blue-600 hover:font-bold text-2xl mx-4 my-1"><a href="dashboard1.php"> Members</a></button> <br><br><br>
                        <button type="button" class="text-white hover:text-blue-600 hover:font-bold text-2xl mx-4 my-1"><a href="dashboard2.php"> Clubs</a></button>
                        <hr>
                        <br>
                        ...
                        <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1"><a
                                href="#">Contact</a></li>
                                <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1"><a
                                    href="settings.html"><img src="images/icons8-gear-24.png" alt="hello"></a></li> -->
                        <!-- <li
                            class="text-blue-600 hover:text-white hover:bg-blue-600 mx-4 my-1 border-2 border-blue-600 px-2 rounded-2xl ">
                            <a href="#">LogIn</a></li>
                        <li
...
<video autoplay="autoplay" muted loop class="animate__animated animate__fadeInUp"><source src="../images/collegevide.mp4" type="video/mp4"></video>
</body>
</html>