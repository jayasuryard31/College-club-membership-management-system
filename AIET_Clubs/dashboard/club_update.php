...
if(isset($_POST['submit'])){
    ...
    $sql = "update `clubinfo` set club_id=$club_id, club_name='$club_name', co_ordinator='$co_ordinator',co_ordinator_id='$co_ordinator_id' where club_id=$club_id";
        ...
        <div class="px-8 py-6 mx-4 mt-4 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3 animate__animated animate__slideInDown">
            ...
            <form  method="post">
                ...
                <div class="mt-4">
			        ...
			        echo '<select name="club_name" required id="club_name">';
					echo '<option value="<?php echo $club_name;  ?>"></option>';
			...
			?>
                    ...
                    <label class="block">co-ordinator<label>
                        <label class="block" for="email"><label>
                                <input type="text" placeholder="co-ordinator" name="co_ordinator" required value="<?php echo $co_ordinator;  ?>"
                    ...
                    <div class="mt-4">
                        <label class="block">co-ordinator id<label>
                                <input type="text" placeholder="co-ordinator id" name="co_ordinator_id" required maxlength=5 minlength=5 value="<?php echo $co_ordinator_id;  ?>"
                                    class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600" />
                    </div>
                    <div>
               <?php
